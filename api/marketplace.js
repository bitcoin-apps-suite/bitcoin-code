// Marketplace API endpoints for Bitcoin App
...
async function getDocumentNFTs(req, res) {
  try {
    ...
    // or maintain a database of all Bitcoin App NFTs
    ...
    const mockNFTs = [
      {
        ...
        nft: {
          ...
          marketUrl: 'https://market.handcash.io/item/bitcoin-app/nft-1'
        },
        trending: true,
      ...
      },
      {
        ...
        nft: {
          ...
          marketUrl: 'https://market.handcash.io/item/bitcoin-app/nft-2'
        },
        trending: false,
      ...
      },
      {
        ...
        nft: {
          ...
          price: 20,
          royaltyPercentage: 8,
          marketUrl: 'https://market.handcash.io/item/bitcoin-app/nft-3'
        },
        trending: true,
