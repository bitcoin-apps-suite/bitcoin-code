...
const GrantSubmissionForm: React.FC<GrantSubmissionFormProps> = ({ 
  ...
  const getFieldPlaceholder = (field: string) => {
    const placeholders: { [key: string]: { [key: string]: string } } = {
      developer: {
        projectTitle: 'Bitcoin App Plugin Development',
      ...
      <div className="submission-success">
        ...
        <div className="nft-info">
          ...
          <ul>
            ...
            <li>Bitcoin App will review and potentially award $BAPP tokens</li>
        ...
        <div className="form-section">
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              >
                <option value="BAPP">$BAPP Tokens</option>
