  ...
  return (
    <div className="pro-taskbar" ref={menuRef}>
      ...
      <div className="taskbar-menus">
        ...
        >
          <span className="menu-title">Bitcoin App</span>
          {activeMenu === 'app' && (
            <div className="menu-dropdown">
              <div className="dropdown-item">About Bitcoin App</div>
        ...
        >
          ...
          {activeMenu === 'help' && (
            <div className="menu-dropdown">
              <div className="dropdown-item">Bitcoin App Help</div>
            </div>
          )}
        </div>
      </div>
