        ...
        <div className="task-info">
          ...
          <div className="task-meta">
            ...
            <span className="reward">
              🪙 {task.tokenReward}% ({(task.tokenReward * 10000000).toLocaleString()} $BAPP)
            </span>
          </div>

          {task.githubIssueNumber && (
            <a 
              href={`https://github.com/bitcoin-apps-suite/bitcoin-app/issues/${task.githubIssueNumber}`}
              target="_blank"
                ...
                <div className="contract-preview">
                  ...
                  <div className="contract-details">
                    ...
                    <div className="contract-item">
                      ...
                      <span className="value">{(task.tokenReward * 10000000).toLocaleString()} $BAPP</span>
                    </div>
                    <div className="contract-item">
