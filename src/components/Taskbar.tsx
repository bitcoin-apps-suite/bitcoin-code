    ...
    },
    {
      ...
      items: [
        ...
        { 
          ...
          href: 'https://github.com/bitcoin-apps-suite/bitcoin-app/issues' 
        }
      ]
    }
  ];
  ...
  return (
    ...
    >
      ...
      <button 
        ...
        title="Bitcoin App - Tap to go home"
      >
        <span className="bitcoin-symbol">₿</span>
        <span>Bitcoin App</span>
      </button>
