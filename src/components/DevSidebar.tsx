...
const DevSidebar: React.FC<DevSidebarProps> = ({ onCollapsedChange }) => {
  ...
  useEffect(() => {
    ...
    fetch('https://api.github.com/repos/bitcoin-apps-suite/bitcoin-app/issues?state=open')
      .then(res => res.json())
  ...
  const menuItems: Array<{
    ...
    // Token & Grants at top
    { path: '/token', icon: DollarSign, label: '$BAPP', badge: 'NEW' },
    ...
    { path: 'https://github.com/bitcoin-apps-suite/bitcoin-app', icon: GitBranch, label: 'GitHub', external: true },
