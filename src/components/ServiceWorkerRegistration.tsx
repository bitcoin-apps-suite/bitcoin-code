  ...
  useEffect(() => {
    if ('serviceWorker' in navigator) {
      navigator.serviceWorker
        ...
        .then((registration) => {
          console.log('Bitcoin App SW registered: ', registration);
            ...
            if (newWorker) {
              newWorker.addEventListener('statechange', () => {
                if (newWorker.state === 'installed' && navigator.serviceWorker.controller) {
                  console.log('Bitcoin App SW updated');
        ...
        .catch((registrationError) => {
          console.log('Bitcoin App SW registration failed: ', registrationError);
        });
    ...
    if ('launchQueue' in window) {
      ...
      launchQueue.setConsumer((launchParams: any) => {
        if (launchParams.targetURL) {
          console.log('Bitcoin App launched with URL:', launchParams.targetURL);
