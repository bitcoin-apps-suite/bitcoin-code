...
export class BitcoinAppNFTService implements NFTService {
  private readonly MAGIC_NUMBER = 'BWNF'; // Bitcoin App NFT
  ...
  private createPlatformSignature(nft: NFTFile): string {
    ...
    const dataToSign = nft.header.contentHash + nft.metadata.title + 'BitcoinApp';
