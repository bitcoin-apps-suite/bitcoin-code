    ...
    <div className="App">
      ...
      <div className="changelog-container">
        ...
        <section className="changelog-hero">
          <h1>Bitcoin App <span style={{color: '#ffffff'}}>Changelog</span></h1>
        ...
        <section className="changelog-entry">
          ...
          <div className="changes-section">
            <h3>Features</h3>
            <ul>
              <li>Initial public release of Bitcoin App</li>
        ...
        <section className="subscribe-section">
          ...
          <div className="subscribe-buttons">
            <a 
              href="https://github.com/bitcoin-apps-suite/bitcoin-app/releases" 
