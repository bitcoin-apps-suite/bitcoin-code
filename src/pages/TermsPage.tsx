      ...
      <div className="terms-container">
        ...
        <div className="terms-content">
          <section className="terms-section">
            ...
            <p>
              These Terms of Service ("Terms", "Agreement") govern your relationship with the Bitcoin App service 
          ...
          <section className="terms-section">
            ...
            <p>
              Bitcoin App is a decentralized document creation and management platform that enables:
            </p>
            <ul>
          ...
          <section className="terms-section">
            ...
            <ul>
              ...
              <li>Bitcoin App never has access to your private keys</li>
          ...
          <section className="terms-section">
            ...
            <div className="contact-info">
              ...
              <p>Email: legal@bitcoin-app.io</p>
              <p>Website: https://bitcoin-app.vercel.app</p>
            </div>
          </section>
          ...
          <section className="terms-section acknowledgment">
            ...
            <p>
              By using Bitcoin App, you acknowledge that you have read, understood, and agree to be 
