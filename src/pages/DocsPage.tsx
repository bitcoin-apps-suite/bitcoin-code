    ...
    <div className="App">
      ...
      <div className="docs-container">
        ...
        <section className="docs-hero">
          <h1><span style={{color: '#ffffff'}}>Bitcoin App</span> Documentation</h1>
        ...
        <section className="getting-started-section">
          ...
          <div className="getting-started-content">
            <p>
              Bitcoin App is a <strong>decentralized document platform</strong> that stores your work 
        ...
        <section className="writing-section">
          ...
          <div className="writing-content">
            <p className="intro">
              The Bitcoin App editor provides a powerful yet intuitive writing experience with 
        ...
        <section className="api-section">
          ...
          <div className="api-content">
            <p>
              <strong>REST API:</strong> Bitcoin App provides a comprehensive REST API for document 
          ...
          <div className="troubleshooting-content">
            <div className="faq-grid">
              ...
              <div className="faq-item">
                ...
                <p>Double-check password, Bitcoin App cannot recover lost passwords for security</p>
              </div>
              <div className="faq-item">
            ...
            <div className="support-links">
              ...
              <div className="support-grid">
                <div className="support-item">
                  ...
                  <a href="https://github.com/bitcoin-apps-suite/bitcoin-app/issues" target="_blank" rel="noopener noreferrer">
                    Submit Issue
                  </a>
                </div>
                <div className="support-item">
                  ...
                  <a href="https://twitter.com/bitcoin_app" target="_blank" rel="noopener noreferrer">
                    @bitcoin_app
                  </a>
                </div>
                <div className="support-item">
