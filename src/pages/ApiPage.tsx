    ...
    <div className="App">
      ...
      <div className="api-container">
        ...
        <section className="api-hero">
          <h1>Bitcoin App <span style={{color: '#ffffff'}}>API</span></h1>
          <p className="api-tagline">
            Complete API reference for integrating Bitcoin App
          </p>
        ...
        {activeSection === 'authentication' && (
          <section className="api-content-section">
            ...
            <div className="api-description">
              <p>Bitcoin App API uses API keys to authenticate requests. You can view and manage your API keys in your account settings.</p>
            </div>
