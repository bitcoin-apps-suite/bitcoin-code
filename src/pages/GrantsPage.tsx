      ...
      <div className={`grants-page ${!isMobile && !devSidebarCollapsed ? 'with-sidebar-expanded' : ''} ${!isMobile && devSidebarCollapsed ? 'with-sidebar-collapsed' : ''}`}>
        <div className="grants-container">
          ...
          <section className="grants-hero">
            ...
            <h1>Bitcoin App <span style={{color: '#FF6B35'}}>Grants</span></h1>
            <p className="grants-tagline">
              $BAPP token awards for quality submissions, plus public discovery platform for independent funding
            </p>
          ...
          <section className="mission-section">
            ...
            <div className="mission-content">
              <p className="mission-statement">
                Bitcoin App creates <strong>a unique funding ecosystem</strong> where quality work gets recognized through 
                $BAPP token awards and becomes discoverable for potential independent funding:
              </p>
              
              <div className="mission-pillars">
                <div className="pillar">
                  <div className="pillar-icon"><DollarSign size={32} /></div>
                  <h3>Bitcoin App Curation</h3>
                  <p><strong>$BAPP token awards for quality work</strong><br/>
                  We review submissions and award $BAPP tokens to exceptional proposals, signaling their quality to the broader ecosystem.</p>
                </div>
                <div className="pillar">
          ...
          <section className="focus-section">
            ...
            <div className="focus-content">
              <p className="focus-intro">
                Our platform showcases exceptional work across key innovation areas. Bitcoin App awards $BAPP tokens 
              ...
              <div className="focus-areas">
                <div className="focus-area">
                  ...
                  <h4>Bitcoin App Platform Development</h4>
                  <ul>
                  ...
                  <div style={{marginTop: '10px', fontSize: '12px', color: '#FF6B35'}}>
                    Bitcoin App awards $BAPP for platform improvements
                  </div>
                </div>
                ...
                <div className="focus-area">
                  ...
                  <div style={{marginTop: '10px', fontSize: '12px', color: '#FF6B35'}}>
                    $BAPP curation signals attract funder attention
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="categories-section">
            ...
            <p className="categories-intro">
              Choose your application path below. Submit your proposal as a public .nft file, compete for $BAPP token awards, 
          ...
          <section className="cta-section">
            <div className="cta-content">
              ...
              <p>
                Apply for Bitcoin App grants to support your innovative projects in blockchain publishing and development. 
                Whether you're a developer pushing technical boundaries, an author sharing knowledge, or a publisher scaling platforms—
                submit your proposal for $BAPP token grant consideration.
              </p>
          ...
          <section className="footer-note">
            <p>
              <strong>Note:</strong> Bitcoin App awards grants in $BAPP tokens to support innovative projects. 
