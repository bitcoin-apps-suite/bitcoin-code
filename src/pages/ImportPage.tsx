        ...
        <section id="how-it-works" className="import-how-section">
          ...
          <div className="import-steps">
            ...
            <div className="import-step">
              ...
              <p>Issue shares in your work, enable revenue sharing, and trade them on the Bitcoin App exchange</p>
            </div>
          </div>
        </section>
        ...
        <section id="benefits" className="import-benefits-section">
          ...
          <div className="import-benefits-grid">
            ...
            <div className="import-benefit">
              ...
              <p>Move your entire writing library to Bitcoin App in minutes, not hours.</p>
            </div>
          </div>
        </section>
