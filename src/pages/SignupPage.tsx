    ...
    return (
      <div className="signup-page">
        <div className="signup-container success">
          ...
          <p>Thank you for signing up. We'll keep you updated on Bitcoin App's development.</p>
    ...
    <div className="signup-page">
      <div className="signup-container">
        ...
        <form onSubmit={handleSubmit} className="signup-form">
          ...
          <div className="form-group">
            <label>I'm interested in Bitcoin App as a:</label>
          ...
          <div className="form-footer">
            <p className="privacy-note">
              We respect your privacy. Your email will only be used for Bitcoin App updates 
        ...
        <div className="signup-benefits">
          ...
          <ul>
            ...
            <li>Exclusive BAPP token opportunities</li>
        ...
        <div className="signup-stats">
          <div className="stat">
            ...
            <span className="stat-label">BAPP Tokens Reserved for Early Users</span>
          </div>
          <div className="stat">
