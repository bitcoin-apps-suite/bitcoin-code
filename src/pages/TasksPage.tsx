...
const TasksPage: React.FC = () => {
  ...
  const fetchGitHubIssues = async () => {
    try {
      const response = await fetch('https://api.github.com/repos/bitcoin-apps-suite/bitcoin-app/issues?state=open&per_page=100');
      ...
      <div className={`tasks-page ${!isMobile && !devSidebarCollapsed ? 'with-sidebar-expanded' : ''} ${!isMobile && devSidebarCollapsed ? 'with-sidebar-collapsed' : ''}`}>
        <div className="tasks-container">
          ...
          <section className="tasks-hero">
            <h1>Bitcoin App <span style={{color: '#ffffff'}}>Tasks</span></h1>
            ...
            <div className="hero-actions">
              ...
              <a 
                href="https://github.com/bitcoin-apps-suite/bitcoin-app/issues/new"
                target="_blank"
