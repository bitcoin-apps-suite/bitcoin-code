    ...
    <div className={`legal-page ${!isMobile ? (devSidebarCollapsed ? 'with-sidebar-collapsed' : 'with-sidebar-expanded') : ''}`}>
      ...
      <div className="legal-container">
        <section className="legal-section">
          ...
          <p>
            Bitcoin App ("we", "our", or "the Service") is committed to protecting your privacy. This Privacy Policy 
        ...
        <section className="legal-section">
          ...
          <p>
            Bitcoin App is not intended for users under 13 years of age. We do not knowingly collect personal 
        ...
        <section className="legal-section">
          ...
          <ul>
            <li><strong>GitHub Issues:</strong> <a href="https://github.com/bitcoin-app" target="_blank" rel="noopener noreferrer">github.com/bitcoin-app</a></li>
            <li><strong>In-App Support:</strong> Use the support feature within Bitcoin App</li>
          </ul>
          <p>
